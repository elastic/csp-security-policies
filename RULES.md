...
| [1.10](bundle/compliance/cis_aws/rules/cis_1_10) |       1   | Ensure multi-factor authentication (MFA) is enabled for all IAM users that have a console password                 | :white_check_mark: | Automated |
