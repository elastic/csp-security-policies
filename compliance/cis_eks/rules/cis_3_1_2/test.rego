...
test_violation {
	test.assert_fail(finding) with input as rule_input("kubeconfig", "root", "owner")
	test.assert_fail(finding) with input as rule_input("kubeconfig", "owner", "root")
	test.assert_fail(finding) with input as rule_input("kubeconfig", "owner", "owner")
}
