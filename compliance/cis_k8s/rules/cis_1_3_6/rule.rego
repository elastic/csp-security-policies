...
finding = result {
	...
	rule_evaluation := common.array_contains(command_args, "RotateKubeletServerCertificate=true")
...
metadata = {
	...
	"impact": "None",
	"tags": array.concat(cis_k8s.default_tags, ["CIS 1.3.6", "Master Node Configuration"]),
