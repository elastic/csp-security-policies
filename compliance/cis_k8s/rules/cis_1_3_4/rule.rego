...
finding = result {
	...
	rule_evaluation := common.array_contains(command_args, "--service-account-private-key-file=")
...
metadata = {
	...
	"tags": array.concat(cis_k8s.default_tags, ["CIS 1.3.4", "Master Node Configuration"]),
