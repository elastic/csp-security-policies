...
test_pass {
	...
	test.assert_pass(finding) with input as rule_input({"pods": [non_violating_pod, non_violating_pod]})
}
...
violating_pod = {
	"kind": "Pod",
	"metadata": {"uid": "1"},
	"spec": {"allowedCapabilities": ["KILL"]},
}

violating_pod2 = {
	"kind": "Pod",
	"metadata": {"uid": "2"},
	"spec": {"allowedCapabilities": ["KILL", "SETFCAP"]},
}
