...
finding = result {
	...
	rule_evaluation := common.array_contains(command_args, "--use-service-account-credentials=true")
...
metadata = {
	...
	"tags": array.concat(cis_k8s.default_tags, ["CIS 1.3.3", "Master Node Configuration"]),
