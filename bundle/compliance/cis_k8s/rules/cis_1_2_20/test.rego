...
test_violation {
	...
	test.assert_fail(finding) with input as rule_input("--audit-log-maxage=29") with data.benchmark_data_adapter as data_adapter
}

test_pass {
	test.assert_pass(finding) with input as rule_input("--audit-log-maxage=30") with data.benchmark_data_adapter as data_adapter
	test.assert_pass(finding) with input as rule_input("--audit-log-maxage=60") with data.benchmark_data_adapter as data_adapter
}
