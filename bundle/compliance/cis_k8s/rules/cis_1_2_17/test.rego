...
test_violation {
	test.assert_fail(finding) with input as rule_input("--secure-port=0") with data.benchmark_data_adapter as data_adapter
}

test_pass {
	test.assert_pass(finding) with input as rule_input("--secure-port=1") with data.benchmark_data_adapter as data_adapter
	test.assert_pass(finding) with input as rule_input("--secure-port=65535") with data.benchmark_data_adapter as data_adapter
