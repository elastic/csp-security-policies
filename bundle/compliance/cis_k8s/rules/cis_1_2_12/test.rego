...
test_pass {
	test.assert_pass(finding) with input as rule_input("--enable-admission-plugins=AlwaysPullImages") with data.benchmark_data_adapter as data_adapter
	test.assert_pass(finding) with input as rule_input("--enable-admission-plugins=NamespaceLifecycle,AlwaysPullImages") with data.benchmark_data_adapter as data_adapter
}
