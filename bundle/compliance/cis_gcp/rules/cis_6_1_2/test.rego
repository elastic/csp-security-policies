...
test_violation {
	...
	eval_fail with input as test_data.generate_gcp_asset(
		type, subtype, {"settings": {"databaseFlags": [{"name": "skip_show_database", "value": "on"}]}},
		{},
	)
}
...
test_pass {
	...
	eval_pass with input as test_data.generate_gcp_asset(type, subtype, {"settings": {"databaseFlags": [{"name": "skip_show_database", "value": "off"}]}}, {})
}
