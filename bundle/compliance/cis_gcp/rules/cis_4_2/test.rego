...
test_violation {
	eval_fail with input as rule_input({"name": "test-instance", "serviceAccounts": [{"email": "12345678-compute@developer.gserviceaccount.com", "scopes": ["https://www.googleapis.com/auth/cloud-platform"]}]})
