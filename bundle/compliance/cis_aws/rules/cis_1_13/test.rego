...
test_pass {
	...
	eval_pass with input as rule_input([{"active": true}], null, null, "", "")
	eval_pass with input as rule_input([{"active": false}, {"active": false}], null, null, "", "")
	eval_pass with input as rule_input([{"active": true}, {"active": false}], null, null, "", "")
}
